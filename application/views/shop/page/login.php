  ...
  <div class="container">
  	...
  	<div class="row">
  		<div class="six columns">
  			...
  			<input value="CREATE ACCOUNT" type="submit" class="button button-primary" style="margin-top:10px;">
  			<hr />
  		...
  		<div class="six columns">
  			...
  			<p><b>E-mail ***</b></p>
  			<input class="u-full-width" placeholder="example: info@jackston.com" id="exampleEmailInput" type="email">
  			<p><b>Password ***</b><span style="float: right;"><i>Forgot Your Password ??</i></span></p>
  			<input class="u-full-width" placeholder="" id="exampleEmailInput" type="password">
