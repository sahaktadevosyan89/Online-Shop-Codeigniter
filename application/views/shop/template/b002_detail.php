  ...
  <div class="container">
		<div class="row">
			<div class="twelve columns">
				<div id="p1a" class="isi">  
					<div id="slider1">
					  <a class="control_next"><img src="<?php echo base_url();?>assets/img/arr/arrRight.png"/></a>
					  <a class="control_prev"><img src="<?php echo base_url();?>assets/img/arr/arrLeft.png"/></a>
					  <ul>
					    <li>
					    	<div class="acc1">
								<img class="one-half column gmbprodukc" src="<?php echo base_url();?>assets/img/produk/1.jpg"/>
								<img class="one-half column gmbprodukc" src="<?php echo base_url();?>assets/img/produk/2.jpg"/>
							</div>
					    </li>
					    <li>
					    	<div class="acc2">
								...
								<div class="one-half column">
									...
									<div class='item' style='background-image: url("<?php echo base_url();?>assets/img/arr/arrBottom.png");'>DESCRIPTION</div>
									...
									<div class='item-data'>
										<div class="row">
											<div class="two columns">
												<img width="100%" src="<?php echo base_url();?>assets/img/produk/color/1.jpg"/>
											</div>
											<div class="two columns">
												<img width="100%" src="<?php echo base_url();?>assets/img/produk/color/2.jpg"/>
											</div>
											<div class="two columns">
												<img width="100%" src="<?php echo base_url();?>assets/img/produk/color/3.jpg"/>
											</div>
											<div class="two columns">
												<img width="100%" src="<?php echo base_url();?>assets/img/produk/color/4.jpg"/>
											</div>
										</div>
									</div>
...
Due to the high volume of orders during promotions or sales, we regret we cannot make any amendments to purchases once ordered and the processing of returns will take longer than normal.
									...
									<div class="twelve columns">
										<div class="one-half column">
											...
											<div class="sosmed">
												<img width="15%" src="<?php echo base_url();?>assets/img/sosmed/twitter.png"></img>
												<img width="15%" src="<?php echo base_url();?>assets/img/sosmed/instagram.png"></img>
												<img width="15%" src="<?php echo base_url();?>assets/img/sosmed/facebook.png"></img>
												<img width="15%" src="<?php echo base_url();?>assets/img/sosmed/tumblr.png"></img>
												<img width="15%" src="<?php echo base_url();?>assets/img/sosmed/pinterest.png"></img>
												<img width="15%" src="<?php echo base_url();?>assets/img/sosmed/youtube.png"></img>
											</div>
										</div>
										<div class="one-half column">
